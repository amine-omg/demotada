<template>
  <div class="min-h-screen bg-[#F8F9FA] font-sans text-[#1A1A1A] flex flex-col relative">
    ...
    <TheHeader pageTitle="SAS de Validation" :showBackButton="false" />

    <div class="flex-1 max-w-[1400px] mx-auto w-full p-8 mt-4 grid grid-cols-12 gap-8 h-[calc(100vh-6rem)]">
          ...
          <div class="flex-1 overflow-y-auto p-8 bg-[#F8F9FA] relative">
            ...
            <div class="grid grid-cols-2 gap-8">
                  ...
                  <div class="space-y-4">
                    ...
                    <div>
                      ...
                      <div class="flex gap-2">
                        ...
                        <a v-if="selectedEnt.contacts[0].telephone" :href="`tel:${selectedEnt.contacts[0].telephone}`" class="w-9 h-9 bg-black rounded-lg flex items-center justify-center text-[#D4AF37] hover:scale-110 transition-transform shrink-0 shadow-sm" title="Appeler">
                    ...
                    <div>
                      ...
                      <div class="flex gap-2">
                        ...
                        <a v-if="selectedEnt.contacts[0].email" :href="`mailto:${selectedEnt.contacts[0].email}`" class="w-9 h-9 bg-gray-100 rounded-lg flex items-center justify-center text-gray-500 hover:bg-black hover:text-[#D4AF37] transition-colors shrink-0">
              ...
              <div v-if="selectedEnt.qualifications?.rgeValide" class="p-5 bg-green-50 border-2 border-green-500 rounded-xl mb-4 flex flex-col gap-4 relative overflow-hidden">
                <div class="absolute -right-4 -top-4 text-green-500/10 transform rotate-12 pointer-events-none">
                ...
                <div class="flex items-start gap-4 z-10">
                  ...
                  <div>
                    ...
                    <p class="text-[10px] text-green-700 font-bold mt-1">L'entreprise possède {{ selectedEnt.qualifications?.details?.length || 0 }} certification(s) active(s).</p>
                  </div>
                </div>

                <div class="mt-2 space-y-2 z-10">
                  <div v-for="(certif, idx) in selectedEnt.qualifications?.details" :key="idx" class="bg-white/80 border border-green-200 rounded-lg p-3 flex justify-between items-center shadow-sm">
                    <div>
              ...
              <div v-else class="p-4 bg-orange-50 border border-orange-200 rounded-xl flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-[10px] font-bold text-orange-600 mt-1">L'inscription d'un installateur sans RGE doit faire l'objet d'une vérification stricte avant de valider la demande.</p>
                </div>
              </div>
            </div>
