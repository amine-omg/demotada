  ...
  <div :class="isMobile ? 'h-[100dvh]' : 'h-screen'" class="w-full bg-[#F8F9FA] font-sans text-[#1A1A1A] flex flex-col overflow-hidden relative">
          ...
          <div class="flex flex-col text-left w-full min-w-0">
            ...
            <div class="flex items-center gap-2 w-full min-w-0">
              ...
              <button @click="startEditClient" class="p-2 hover:bg-gray-100 rounded-full transition-colors shrink-0">
                <svg class="w-5 h-5 text-[#D4AF37]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>
              </button>
            </div>
          </div>
              ...
              <div class="grid grid-cols-3 gap-4 overflow-visible flex-1 items-start mt-4 pr-1 custom-scrollbar-v">
                ...
                <div class="flex flex-col gap-2 group cursor-pointer" @click="activeDoc = 'ah'; showDocModal = true">
                   ...
                   <div class="relative aspect-[21/29.7] w-full bg-white border-2 border-black rounded shadow-sm overflow-hidden group-hover:shadow-[4px_4px_0px_0px_rgba(212,175,55,0.2)] transition-all">
                      <img src="/ah.png" class="w-full h-full object-cover transition-all duration-300" :class="{'blur-[2px] opacity-60': !isAhGenerated, 'blur-0 opacity-100': isAhGenerated}" />
                      <div class="absolute inset-0 bg-black/5 group-hover:bg-transparent transition-colors"></div>
                      <div class="absolute inset-0 flex items-center justify-center p-2 text-center backdrop-blur-[1px]" :class="isAhGenerated ? 'hidden' : ''">
    ...
    <Teleport to="body">
      <div v-if="showDocModal" class="fixed inset-0 z-[1000] flex items-center justify-center bg-black/95 backdrop-blur-xl p-4 md:p-10 animate-fade-in">
         <button @click="showDocModal = false" class="absolute top-4 right-4 md:top-5 md:right-10 bg-[#D4AF37] text-white p-3 md:p-4 rounded-full hover:rotate-90 transition-all duration-300 shadow-2xl z-20">
         ...
         <div class="w-full max-w-6xl h-[85vh] md:h-full bg-white rounded-xl overflow-hidden shadow-2xl relative border-2 border-black/10 mt-12 md:mt-0">
